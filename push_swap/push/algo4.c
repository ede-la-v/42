...
/*   Updated: 2017/12/23 12:56:53 by ede-la-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	rotate_it(int **tab, t_int len, t_int minmax, t_int *len_tmp)
{
	...
	if (place(tab, minmax.b - 3, len_tmp) < min)
		min = place(tab, minmax.b - 3, len_tmp);
